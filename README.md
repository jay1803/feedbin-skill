...
- Optional org-roam integration (keeps both markdown and podcast MP3 archives for audio entries, then moves them into attachment paths; video URLs still become ref-only notes)
...
# Pull + create org-roam notes; audio entries keep both markdown and podcast MP3 attachments
